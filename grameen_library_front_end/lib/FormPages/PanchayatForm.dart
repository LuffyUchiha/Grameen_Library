...
class PanchayatForm extends StatefulWidget {
  @override
  _PanchayatFormState createState() => _PanchayatFormState();
}

class _PanchayatFormState extends State<PanchayatForm> {
  String _name;
  String _pocname;
  String _email;
  String _phone;
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: 'Point of Contact Phone No.',
                      ),
                      validator: (String value) {
                        if (value.isEmpty ) {
                          return 'This field cannot be empty';
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: 'Point of Contact Address',
                      ),
                      validator: (String value) {
                        if (value.isEmpty) {
                          return 'This field cannot be empty';
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        var res=0;
                        try{
                          await client.post("http://127.0.0.1:5000/register/panchayat",
                              body : {"Panchayat Name":_name,"PoC Name":_pocname,"Email":_email,"Phone":_phone,"Address":_address,"Password":_password})
                              .then((response) {
